...
import { Package, Gift, ArrowLeft, Send } from "lucide-react";
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <FlameButton
                        size="sm"
                        className="flex-1"
                        onClick={() => giftItem(item.id)}
                        disabled={!giftUsername.trim() || sending}
                      >
                      ...
                      <FlameButton
                        size="sm"
                        variant="outline"
                        onClick={() => { setGiftingId(null); setGiftUsername(""); }}
                      >
                        Отмена
                      </FlameButton>
                    </div>
